...
public class AirportTest {
    ...
    private static final ExperimentalType HYPERSONIC_EXPERIMENTAL_TYPE = ExperimentalType.HYPERSONIC;
    ...
    @Test
    public void testHasZeroLiftingBodyExperimentalPlanes() {
        Assert.assertTrue(new Airport(planes).getExperimentalPlanesByCertainType(LIFTING_BODY_EXPERIMENTAL_TYPE).isEmpty());
    }

    @Test
    public void testHasZeroHypersonicExperimentalPlanes() {
        Assert.assertTrue(new Airport(planes).getExperimentalPlanesByCertainType(HYPERSONIC_EXPERIMENTAL_TYPE).isEmpty());
    }
